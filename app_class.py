...
###################### HELPER FUNCTIONS #####################################
            ...
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    if char == "1":
                        ...
                        self.pills.append(vec(xidx, yidx))
    ...
    def draw_grid(self):
      ...
      #    pygame.draw.rect(self.background, WHITE, (coin.x*self.cell_width,
...
###################### INTRO FUNCTIONS ######################################
    ...
    def start_draw(self):
        ...
        self.draw_text('1 PLAYER ONLY', self.screen, [WIDTH // 2, HEIGHT // 2+50],
                       START_TEXT_SIZE, (44, 167, 198), START_FONT)
...
###################### PLAYING FUNCTIONS ######################################
    ...
    def playing_draw(self):
        ...
        #self.draw_grid()
        self.draw_text('CURRENT SCORE: {}'.format(self.player.current_score), self.screen, [150, 10], 18, WHITE,
                       START_FONT)
        self.draw_text('HIGH SCORE: 0', self.screen, [WIDTH//2+150, 10], 18, WHITE,
                       START_FONT)
        self.player.blitme()
        self.player.draw()
        for enemy in self.enemies:
    ...
    def draw_power_pills(self):
        for power in self.pills:
            pygame.draw.circle(self.screen, WHITE,
                               (int(power.x * self.cell_width) + self.cell_width // 2 + TOP_BOTTOM_BUFFER // 2,
                                int(power.y * self.cell_height) + self.cell_height // 2 + TOP_BOTTOM_BUFFER // 2), 8)
